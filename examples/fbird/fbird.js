...
//      var steps        = Math.ceil(timeDelta/accelData.interval);
      ...
      var posArrayx4            = new Float32Array(posArray.buffer);
      var velArrayx4            = new Float32Array(velArray.buffer);
      ...
      for (var i = 0, len = (actualBirds+3)>>2; i < len; ++i) {
        ...
        var newPosx4 = SIMD.Float32x4.load(posArrayx4, i);
        var newVelx4 = SIMD.Float32x4.load(velArrayx4, i);
        ...
        SIMD.Float32x4.store(posArrayx4, i, newPosx4);
        SIMD.Float32x4.store(velArrayx4, i, newVelx4);
      }
    }
...
//          var reduceCount = birdCount < 20 ? 1 : adjustCount(fps, targetFps);
  ...
  var parameters = function () {
    ...
    var parameters = {
      ...
      "startX":             "random",
      "startY":             "random",
      "width":              "800",  // inherit from enclosing div
      "height":             "400",  // inherit from enclosing div
      "initialize":         "true",
